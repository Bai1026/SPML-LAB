...
# for i, line in enumerate(open('others_to_en.tsv').readlines()):
#     line = line.split('\t')
#     lang.append(line[0])
#     label.append(line[1])
...
premise = list()
hypothesis = list()
with open("data-bin/XNLI-1.0/xnli.dev.tsv", "r") as f:
...
for i in tqdm(range(len(test_label))):
    predict = XNLI_eval(exampleString + test_premise[i], test_hypothesis[i], verbose=(i%1000==0))
